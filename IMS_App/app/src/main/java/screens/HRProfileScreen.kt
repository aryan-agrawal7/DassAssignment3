...
@Composable
fun HRProfileScreen(onLogout: () -> Unit) {
    ...
    Column(
        ...
        Text(com.DASS_2024111023_2024117009.ims.MockDatabase.currentUser?.name ?: "HR Name", color = TextWhite, fontSize = 24.sp, fontWeight = FontWeight.Bold)
        Text("HR Department", color = TextGray, fontSize = 14.sp) // Updated to match Figma, badge removed
        ...
        Card(colors = CardDefaults.cardColors(containerColor = CardDark), modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(20.dp)) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column { Text("EMAIL ADDRESS", color = TextGray, fontSize = 10.sp); Text("alex.hr@institute.edu", color = TextWhite, fontSize = 14.sp) }
                }
                Spacer(modifier = Modifier.height(16.dp))
                Row(verticalAlignment = Alignment.CenterVertically) {
